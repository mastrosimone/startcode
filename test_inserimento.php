...
<?php
    if(isset($_POST['save'])){
    	$sql = "INSERT INTO books (title, category, created_at)
        VALUES (' " . $_POST["title"] . " ' , ' " . $_POST["category"] . " ', NOW())";
        $mysqli->query($sql);
    }
    ...
    <form method="post"> 
    <label id="first"> Titolo:</label><br/>
    <input type="text" name="title"><br/>

    <label id="first">Categoria</label><br/>

	  <input type="radio" name="category" value="1"> Fantastico<br/>
	  <input type="radio" name="category" value="2"> Giallo<br/>
	  <input type="radio" name="category" value="3"> Scientifico<br/>
